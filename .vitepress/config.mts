      ...
      '/work/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: '04. Vue', link: '/work/v3' },
            { text: '05. HarmonyOS', link: '/work/hm' },
            { text: '06. React', link: '/work/react' },
            { text: '07. CI/CD（Jenkins/Docker）', link: '/work/cicd' },
            { text: '08. 小程序', link: '/work/applet' },
            { text: '09. Next.js', link: '/work/next' },
